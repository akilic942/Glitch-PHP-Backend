...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('event_ticket_purchase_transactions', function (Blueprint $table) {
            $table->uuid('id');
            $table->primary('id');
            ...
            $table->foreign('purchase_id')->references('id')->on('event_ticket_purchases')->onDelete('cascade');

            $table->timestamps();
        });

        DB::statement('ALTER TABLE event_ticket_purchase_transactions ALTER COLUMN id SET DEFAULT uuid_generate_v4();');
    ...
    {
        Schema::dropIfExists('event_ticket_purchase_transactions');
    }
};
