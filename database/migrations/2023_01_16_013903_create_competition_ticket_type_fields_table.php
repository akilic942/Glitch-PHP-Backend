...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('competition_ticket_type_fields', function (Blueprint $table) {
            $table->uuid('id');
            $table->primary('id');
            ...
            $table->foreign('section_id')->references('id')->on('competition_ticket_type_sections')->onDelete('cascade');

            $table->timestamps();
        });

        DB::statement('ALTER TABLE competition_ticket_type_fields ALTER COLUMN id SET DEFAULT uuid_generate_v4();');
    ...
    {
        Schema::dropIfExists('competition_ticket_type_fields');
    }
};
